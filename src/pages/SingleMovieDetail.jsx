...
export async function loader({ params }) {
  ...
  const URL = `https://www.omdbapi.com/?apikey=${apikey}&plot=full&i=${imdbId}`;
  try {
...
// jab mera singleMoviedetail component run use se phele se mera loader function chal jayega
